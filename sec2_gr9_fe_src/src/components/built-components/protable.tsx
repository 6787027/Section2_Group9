...
export default function Protable({id, name, price, imageUrl, type, quantity, desc, colid }: Product) {
    ...
    return (
        <tr>
            ...
            <td className="items-center">
                <button className="" onClick={()=>document.getElementById('desc').showModal()}>
                ...
                <dialog id="desc" className="modal">
