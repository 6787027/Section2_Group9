...
export default function ProductInfo({ name, price, imageUrl, type, genre, quantity,desc }: ProductInfo) {
        ...
        <main className="flex flex-col">
            <div className="mt-10 flex flex-row justify-center">
                ...
                <div>
                    ...
                    <p className="break-all ml-5 mt-5 text-white max-w-screen text-start">
                        {desc}
                    </p>
                    </div>
